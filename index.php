  ...
  <body>
    ...
    <header class="jumbotron bg-inverse text-xs-center center-vertically" role="banner">
      <div class="container">
        ...
        <h2 class="m-b-3">Bersih, <em>Wangi</em>, dan Ekonomis <br><a href="ui-elements.html" class="jumbolink">powered by UNIKOM</a>.</h2>
        ...
        <div class="row">
          ...
          <div class="col-md-6 col-lg-7">
            <ul class="nav nav-inline">
              <li class="nav-item">
                <a class="nav-link" href="">Untuk Memenuhi Mata Kuliah SBD<span class="sr-only"></span></a>
              </li>
            </ul>
          </div>
        </div>
